...
//
// ACCEPTED COST, stated rather than hidden: a re-run that changes only the truncation notice says
// nothing, because no finding is new. The summary already on the pull request is then one push
// stale about how much of the change was covered.
